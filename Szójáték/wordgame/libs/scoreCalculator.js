/**
 * @constructor
 * @param {Nubmer} [opt_maxLevel] - The maximal level of the game calculated from settings.
 * @param {Nubmer} [opt_actLevel] - The level of the actual game. The interval of opt_actLevel's value = [0 .. opt_maxLevel] .
 */
var ScoreCalculator = /** @class */ (function () {
    function ScoreCalculator(maxLevel, actLevel) {
        if (maxLevel) {
     ...
     */
    ScoreCalculator.prototype.getDisplayedScore = function (goodValues, actValues, acceptableValues, weights) {
        ...
        var maxScore = 400 + this.actLevel * 400 / this.maxLevel;
        var levelDeduction = 400 / this.maxLevel * this.invActLevel;
        var userPerformanceDeduction = 0;
        ...
        var combinedError = levelDeduction + maxScore * userPerformanceDeduction;
        var score = 1000;
    ...
    ScoreCalculator.prototype.getRealScore = function (goodValues, actValues, acceptableValues, weights) {
        if (goodValues.length != actValues.length || goodValues.length != acceptableValues.length || goodValues.length != weights.length) {
            throw "The function parameters haven't got the same size.";
        }
        var maxScore = 400 + this.actLevel * 400 / this.maxLevel;
