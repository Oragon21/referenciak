...
public class CreateVaccinePopUp extends PopUp{

    private JButton bAmnesia;
    private JButton bChorea;
    private JButton bParalyzing;

    public CreateVaccinePopUp(Map map){
        ...
        bAmnesia.setEnabled(
                ...
                amnesiaGeneticCode.getCostAmVaccine() <= player.getInventoryAm() && //Van elég amino
                amnesiaGeneticCode.getCostNucVaccine() <= player.getInventoryNuc()  //Van elég nucleo
        );

        bChorea.setEnabled(
                choreaGeneticCode != null &&   //A player ismeri a kódot;
                choreaGeneticCode.getCostAmVaccine() <= player.getInventoryAm() && //Van elég amino
                choreaGeneticCode.getCostNucVaccine() <= player.getInventoryNuc()  //Van elég nucleo
        );

        bParalyzing.setEnabled(
                paralyzingGeneticCode != null &&   //A player ismeri a kódot;
                paralyzingGeneticCode.getCostAmVaccine() <= player.getInventoryAm() && //Van elég amino
                paralyzingGeneticCode.getCostNucVaccine() <= player.getInventoryNuc()  //Van elég nucleo
        );
    ...
    public void open(Map map, Player targetPlayer){
        ...
        bAmnesia.addActionListener(act -> {
            ...
            if(amnesiaGeneticCode != null) {
               player.makeVaccine(amnesiaGeneticCode);
               System.out.println("Vaccine létrehozva");
            }
        ...
        bChorea.addActionListener(act -> {
            ...
            if(choreaGeneticCode != null) {
                player.makeVaccine(choreaGeneticCode);
                System.out.println("Vaccine létrehozva");
            }
        ...
        bParalyzing.addActionListener(act -> {
            ...
            if(paralyzingGeneticCode != null) {
                player.makeVaccine(paralyzingGeneticCode);
                System.out.println("Vaccine létrehozva");
            }
